    ...
    $(
      ...
      macro_rules! $name {
        ($text:expr) => {{
          ...
          const ABC678_PREFIX_THAT_SHOULD_NEVER_CLASH_WITH_OUTER_SCOPE_UTF8: &$crate::utf16::internals::core::primitive::str = $text;
          {
            use $crate::utf16::internals::core::prelude::v1::*;
            const ABC678_PREFIX_THAT_SHOULD_NEVER_CLASH_WITH_OUTER_SCOPE_LEN: usize =
              $crate::utf16::internals::length_as_utf16(ABC678_PREFIX_THAT_SHOULD_NEVER_CLASH_WITH_OUTER_SCOPE_UTF8) + $n;
            const ABC678_PREFIX_THAT_SHOULD_NEVER_CLASH_WITH_OUTER_SCOPE_UTF16: &'static [u16; ABC678_PREFIX_THAT_SHOULD_NEVER_CLASH_WITH_OUTER_SCOPE_LEN] = {
              ...
              let mut i = 0;
              while let Some((ch, rest)) = $crate::utf16::internals::next_code_point(bytes) {
                bytes = rest;
